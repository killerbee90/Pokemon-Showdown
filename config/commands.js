...
var commands = exports.commands = {
	...
	shop: function (target, room, user) {
		if (!this.canBroadcast()) return false;
		this.sendReplyBox(
			'<center><h3><b><u>Tienda de Ultimate</u></b></h3><table border="1" cellspacing="0" cellpadding="3" target="_blank"><tbody>' +
	...
	shophelp: function () {
		if (!this.canBroadcast()) return false;
		this.sendReplyBox(
			"<center><h3><b><u>Tienda de Ultimate</u></b></h3></center>" +
	...
	customsymbol: function (target, room, user) {
		if (!Shop.symbolPermision(user.name) && !user.can('givemoney')) return  this.sendReply('Debes comprar este comando en la tienda para usarlo.');
